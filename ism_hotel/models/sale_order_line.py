...
class SaleOrderLine(models.Model):
    ...
    def create(self, vals):
        ...
        self.creation_resrvatiom()
        logging.critical('SSSSSSSSSSSSSSS')

        result = super(SaleOrderLine, self).create(vals)
        logging.critical('SSSSSSSSSSSSSSS')

        result.creation_resrvatiom()
        return result
    ...
    def write(self, vals):
        ...
        _logger.critical("write.website_order_line")
        _logger.critical(result)

        #result.hotel_book_history_ids = [(4,resrvation.id )]
        return result
